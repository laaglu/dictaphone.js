...
module.exports = ViewBase.extend({
  ...
  getIcon : function getIcon() {
    if (commands.isRunning(this.model.id, commands.RECORD)) {
      return RECORD_ICON;
    }
    if (commands.isRunning(this.model.id, commands.PLAY)) {
      return PLAY_ICON;
    }
    return null;
  },
  ...
  updateIcon : function updateIcon() {
    ...
    this.link.attr('href', ['#/', commands.isRunning(this.model.id, commands.RECORD) ? 'record' : 'play', '/', this.model.id].join(''));
  }
});
