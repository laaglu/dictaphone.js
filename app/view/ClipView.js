...
var ClipTemplate = require('./template/ClipTemplate');
...
module.exports = ViewBase.extend({
  ...
  getIcon : function getIcon() {
    if (commands.isRunning(this.model.id, RecordCmd.cmdid)) {
      return RECORD_ICON;
    }
    if (commands.isRunning(this.model.id, PlayCmd.cmdid)) {
      return PLAY_ICON;
    }
    return null;
  },
  ...
  updateIcon : function updateIcon() {
    ...
    this.link.attr('href', ['#/', commands.isRunning(this.model.id, RecordCmd.cmdid) ? 'record' : 'play', '/', this.model.id].join(''));
  }
});
