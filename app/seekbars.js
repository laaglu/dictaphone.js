...
/* globals navigator, window, document, screen, Event*/
...
utils.seekbars = (function() {
  ...
  var Slider = function(slider) {
    ...
    this.handler = slider.querySelector('progress + button');
  ...
  Slider.prototype = {
      ...
      switch (evt.type) {
        ...
        case touchmove:
          ...
          if (x < this.progressLeft) {
            ...
            this.setProgressValue(MAX_VALUE);
          } else {
            this.currentX = x;
            this.updateUI();
          }
    ...
    getValue: function getValue() {
      return getSliderValue(this.progress.value, this.valuemin, this.valuemax);
    },
    setValue: function setValue(value) {
      var vmin = this.valuemin =
        parseFloat(this.slider.getAttribute('aria-valuemin')) || MIN_VALUE;
      var vmax = this.valuemax =
        parseFloat(this.slider.getAttribute('aria-valuemax')) || MAX_VALUE;
      value = (value - vmin) / (vmax - vmin);
      this.setProgressValue(value);
      this.deltaX = value * this.progressWidth;
      this.handler.style[transformProp] = 'translateX(' + this.deltaX + 'px)';
    },
    ...
    placeHandler: function placeHandler(value) {
      this.progressLeft = this.progress.getBoundingClientRect().left;
      this.handler.style.left = (this.progressLeft - this.progress.parentNode.getBoundingClientRect().left) + 'px';
      this.setValue(value);
    },
  ...
  return {
     ...
     *
     * @param{Object} DOMElement of selector that represents the slider
     */
    ...
    create: function create(options) {
      ...
      button.setAttribute('class', 'slider');
